...
if(numberofnotices >0)
{
    ...
    if(noticeIndecies.length >0)
    {
        ...
        if (language)
        {
            ...
            html+='<div class="yellowMessage"><i aria-hidden="true" alt="Attention" class="rbc-icon rbc_attention"></i><span class="accessible">Attention </span>Renseignements importants</div>';
        }
        else
        {
            html+='<div tabindex="-1" role="region" aria-label="Warning" class="yellowNotice notices signinWarning">';
            html+='<div class="yellowMessage"><i aria-hidden="true" alt="Warning" class="rbc-icon rbc_attention"></i><span class="accessible">Warning </span>Important Information</div>';
        }
